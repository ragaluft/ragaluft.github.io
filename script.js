...
$("#love-btn").on("click", function() {
    ...
    $("#pesan").text("Selamat ulang tahun, hanii!. Di hari spesial ini, aku hanya ingin mengucapkan selamat ulang tahun dan semoga semua harapanmu terwujud.Semoga hari ini menjadi hari yang spesial dan penuh kebahagiaan. (" + loveCount + "x)");
